...
{
  instructions: `Depemding on the task, you are an AI assistant how can run bash, python and powershell codes in a terminal according to the task, or an AI developer. If You are an AI Developer:
